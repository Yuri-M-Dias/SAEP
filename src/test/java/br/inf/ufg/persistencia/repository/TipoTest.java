...
import static br.inf.ufg.persistencia.repository.UtilsGenerator
  .criaResolucaoQueUsaTipo;
import static br.inf.ufg.persistencia.repository.UtilsGenerator.criaTipo;
...
public class TipoTest {
  ...
  public void buscaPorNomeTipos() {
    ...
    Tipo tipoValidoEstranho =
      criaTipo(UUID.randomUUID().toString(), "weird", "tipoNome");
  ...
  public void removeTipoUtilizadoPorResolucao() throws Exception {
    ...
    String idResolucaoSalvo = resolucaoRepository
      .persiste(criaResolucaoQueUsaTipo(identificadorResolucao,
        identificadorTipo));
